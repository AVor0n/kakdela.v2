...
public class SurveyServiceGetMySurveysTest extends SurveyServiceTestBase {

  @Test
  void getMySurveys_surveysNotFound_returnEmptyListOfDto() {
    Mockito.when(permissionService.getAccessibleSurveys(SurveyServiceTestConstants.account1Id))
