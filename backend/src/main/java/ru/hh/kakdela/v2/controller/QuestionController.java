...
public class QuestionController {
  ...
  public QuestionResponseDto create(
    ...
    return questionService.create(pageId, createDto, authenticatedUser.getId());
  }
  ...
  public QuestionResponseDto update(
    ...
    return questionService.update(questionId, updateDto, authenticatedUser.getId());
  }
  ...
  public void delete(
    ...
    questionService.delete(questionId, authenticatedUser.getId());
  }
}
