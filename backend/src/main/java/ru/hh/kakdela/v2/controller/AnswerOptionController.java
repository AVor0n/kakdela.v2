...
public class AnswerOptionController {
  ...
  public AnswerOptionResponseDto create(
    ...
    return answerOptionService.create(questionId, createDto, authenticatedUser.getId());
  }
  ...
  public AnswerOptionResponseDto update(
    ...
    return answerOptionService.update(optionId, updateDto, authenticatedUser.getId());
  }
  ...
  public void delete(
    ...
    answerOptionService.delete(optionId, authenticatedUser.getId());
  }
}
